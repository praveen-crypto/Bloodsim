    ...
    ##########################END OF DOCKWIDGET_3
        ...
        def button_analyse(self):
            ...
            if Index == 0 or Index1 == 0:
                ...
                self.pressure_max = str(self.pulse[self.plot_p, 6000:].max())
                self.pressure_min = str(self.pulse[self.plot_p, 6000:].min())
                self.flowmax = str(self.pulse[self.plot_f, 6000:].max())
                self.flowmin = str(self.pulse[self.plot_f, 7200:].min())
