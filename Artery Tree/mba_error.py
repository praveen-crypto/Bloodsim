...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        sizePolicy.setHeightForWidth(self.graphWidget_1.sizePolicy().hasHeightForWidth())
        ...
        self.graphWidget_2.plotItem.setTitle("second widget")
        self.gridLayout_9.addWidget(self.graphWidget_2, 3, 0, 1, 3)
        #t1 = np.arange(0, 2, 0.02)
        #x1 = np.sin(2*3.14*t1)
        #self.graphWidget_2.plotItem.plot(t1, x1)
        ...
        self.dockWidget_1.setStyleSheet("color:rgb(255, 255, 255);")
        self.dockWidget_3.setStyleSheet("color:rgb(255, 255, 255);")
...
##########################END OF DOCKWIDGET_3
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_4.setText(_translate("MainWindow", "INLET/OUTLET"))
    ...
    def showDock_3(self):
        if self.actionHeart_Parameter.isChecked():
            ...
            #self.label_heart.setPixmap(QPixmap('heart.png'))
            self.label_heart.setPixmap(QPixmap('heart.png'))
    ...
    def about(self):
        ...
        about.setWindowIcon(QtGui.QIcon('logo.png'))
    ...
    def button_chambers(self):
        ...
        self.label_heart.setPixmap(QPixmap('chambers.png'))
    ...
    def button_valves(self):
        ...
        self.label_heart.setPixmap(QPixmap('valves.png'))
    ...
    def button_iandolet(self):
        self.label_heart.clear()
        self.label_text_4.clear()
        self.label_heart.setPixmap(QPixmap('iandolets.png'))
        self.label_text_4.setAlignment(QtCore.Qt.AlignLeft | QtCore.Qt.AlignTop)
