...
stn_data = {'0': None, '1': None, '7': None, '13': None, '3': None, '11': None, '10': None, '51': None,
            '46': None, '74': None, '56': None, '70': None, '62': None, '63': None, '108': None,
            '109': None, '102': None, '107': None, '96': None, '92': None}
class Ui_widget_1(object):
    def setupUi(self, widget_1):
        widget_1.setObjectName("widget_1")
        widget_1.resize(750, 458)
        widget_1.setStyleSheet("background-color: rgb(43, 80, 120);\n"
                               "border-color: rgb(0,0,0);\n"
                               "border-right-color: rgb(43, 80, 120);")
        self.gridLayout_2 = QtWidgets.QGridLayout(widget_1)
        self.gridLayout_2.setObjectName("gridLayout_2")
        self.tabWidget = QtWidgets.QTabWidget(widget_1)
        ...
        self.label_VE_VI_2 = QtWidgets.QLabel(self.tab_1)
        self.label_VE_VI_2.setStyleSheet("font: 9pt \"MS Shell Dlg 2\";\n"
                                         "color: rgb(255,255,255);")
        self.label_VE_VI_2.setObjectName("label_VE_VI_2")
        self.gridLayout.addWidget(self.label_VE_VI_2, 1, 8, 1, 1)
    ...
    def retranslateUi(self, widget_1):
        ...
        self.label_VE_VI_2.setText(_translate("widget_1", "Venous inertance"))
...
"color: rgb(255,255,255);")
        ...
        global stn_data
        '''
        stn_data={'0': self.doubleSpinBox_AO.value(), '1': self.doubleSpinBox_AA.value(),
                  '7': self.doubleSpinBox_SAL.value(), '13': self.doubleSpinBox_SAR.value(),
                  '3': self.doubleSpinBox_CCL.value(), '11': self.doubleSpinBox_CCR.value(),
                  '10': self.doubleSpinBox_TA.value(), '51': self.doubleSpinBox_CAR.value(),
                  '46': self.doubleSpinBox_CAL.value(), '74': self.doubleSpinBox_AbAO.value(),
                  '56': self.doubleSpinBox_BAR.value(), '70': self.doubleSpinBox_BAL.value(),
                  '62': self.doubleSpinBox_HA.value(), '63': self.doubleSpinBox_RA.value(),
                  '108': self.doubleSpinBox_FAL.value(), '109': self.doubleSpinBox_FAR.value(),
                  '102': self.doubleSpinBox_UAL.value(), '107': self.doubleSpinBox_UAR.value(),
                  '96': self.doubleSpinBox_RAL.value(), '92': self.doubleSpinBox_RAR.value()}
        '''
    ...
    def enable_box(self):
        ...
        else: self.doubleSpinBox_AA.setDisabled(True)
...
class Ui_HomeWindow():
    ...
    def setupUi(self):
        ...
        self.retranslateUi(self.HomeWin)
        QtCore.QMetaObject.connectSlotsByName(self.HomeWin)

    def retranslateUi(self, HomeWin):
        _translate = QtCore.QCoreApplication.translate
        HomeWin.setWindowTitle(_translate("HomeWin", "BloodSim"))
...
class Controller:
    ...
    def Heart_para(self):
        ...
        self.wui = Ui_widget_1()
        self.wui.setupUi(self.widget_1)
        self.widget_1.show()
